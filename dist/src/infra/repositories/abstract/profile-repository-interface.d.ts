...
export interface ProfileRepositoryInterface {
    ...
    update(body: ProfileEntityInterface, profileid: string): Promise<ProfileEntityInterface | void>;
    delete(profileId: string): Promise<ProfileEntityInterface | void>;
    updateFavoriteGames(profileId: string, favoriteGames: string[]): Promise<void | ProfileEntityInterface>;
